  ...
  return (
    <main className="relative min-h-screen bg-white text-gray-800 overflow-x-hidden font-sans">
      ...
      <Link
        ...
        className="fixed top-15 sm:top-20 md:top-15 right-3 sm:right-6 md:right-10 lg:right-14 z-40 group flex flex-col items-center justify-center bg-[#0f3358]/80 hover:bg-[#7d311f]/90 backdrop-blur-lg text-white px-5 sm:px-7 py-2.5 sm:py-3.5 rounded-2xl sm:rounded-3xl border-2 border-[#D4AF37]/80 hover:border-[#D4AF37] shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 whitespace-nowrap text-center leading-tight ring-1 ring-white/20"
      >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-8 md:px-12 lg:px-16 py-6 sm:py-10 space-y-4 sm:space-y-6">
        ...
        {/*  Closing Institutional Photo Feature */}
        ...
        <footer className="pt-2 sm:pt-3 border-t border-gray-200 text-center text-[11px] sm:text-xs md:text-sm text-gray-500 space-y-0.2">
