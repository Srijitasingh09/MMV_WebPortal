      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#F8FAFC] rounded-xl border border-slate-200 p-4 sm:p-6 space-y-3">
          ...
          <div className="bg-white p-4 rounded-lg border border-slate-200 text-xs sm:text-sm font-mono space-y-2 text-slate-800 leading-relaxed">
            <p><strong className="text-primary">First Line of Content:</strong> Becomes the main big section title with underline.</p>
            <p><strong className="text-primary">## Section Title:</strong> Creates a major heading (Deep Navy font with maroon bar).</p>
            <p><strong className="text-primary">### Subsection Title:</strong> Creates a smaller subheading (Rotated diamond badge).</p>
            <p><strong className="text-primary">- List item:</strong> Converts to bullet point.</p>
            ...
            <p><strong className="text-primary">[Link Text](/facilities/hostels):</strong> Converts to clickable link (internal or web link).</p>
            <p><strong className="text-primary">---:</strong> Inserts horizontal divider line.</p>
          </div>
        </div>
        ...
        <div className="bg-[#F8FAFC] rounded-xl border border-slate-200 p-4 sm:p-6 space-y-3">
          ...
          <ul className="text-xs sm:text-sm text-slate-700 space-y-2 list-disc list-inside font-medium leading-relaxed">
            ...
            <li><strong className="text-primary">Interactive Tables:</strong> Click <code className="bg-white px-1 py-0.5 rounded border border-slate-200 font-mono">+ Col</code> to add custom columns and <code className="bg-white px-1 py-0.5 rounded border border-slate-200 font-mono">Add Row</code> for structured data tables. Use ▲ / ▼ to reorder rows easily.</li>
          </ul>
        </div>
